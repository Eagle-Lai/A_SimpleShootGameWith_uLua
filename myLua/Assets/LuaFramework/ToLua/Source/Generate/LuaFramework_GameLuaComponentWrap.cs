...
public class LuaFramework_GameLuaComponentWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(LuaFramework.GameLuaComponent), typeof(UnityEngine.MonoBehaviour));
	...
	static int Add(IntPtr L)
	{
		try
		{
			...
			LuaInterface.LuaTable o = LuaFramework.GameLuaComponent.Add(arg0, arg1);
			ToLua.Push(L, o);
			return 1;
		}
		catch(Exception e)
	...
	static int Get(IntPtr L)
	{
		try
		{
			...
			UnityEngine.GameObject arg0 = (UnityEngine.GameObject)ToLua.CheckUnityObject(L, 1, typeof(UnityEngine.GameObject));
			LuaTable arg1 = ToLua.CheckLuaTable(L, 2);
			LuaInterface.LuaTable o = LuaFramework.GameLuaComponent.Get(arg0, arg1);
			ToLua.Push(L, o);
			return 1;
		}
		catch(Exception e)
